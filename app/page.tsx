  ...
  return (
    <main className="w-screen bg-orange-200">
      <div className="min-h-screen  container mx-auto p-4 max-w-3xl">
        ...
        {/* Basic Stat Display */}
        {isStatsVisible && (
          <div className="bg-gray-200 p-4  border border-black rounded-lg shadow-md mb-6 dark:bg-white-300">
        ...
        <div className="flex flex-row gap-x-2 mb-4">
          <button
            ...
            className="bg-gray-200 text-gray-800 p-2 border border-black rounded-lg font-medium hover:bg-gray-300 transition-colors dark:bg-zinc-700 dark:text-white dark:hover:bg-zinc-600 shadow-md flex items-center gap-2">
        ...
        {isFilterVisible && (
          <div className="p-4 bg-gray-200 dark:bg-zinc-900 rounded-xl shadow-lg border border-blackdark:border-zinc-700 mb-6">
        ...
        {isFormVisible && (
          <div className="flex flex-col gap-3 mb-8 p-4 bg-gray-200 dark:bg-zinc-900 rounded-xl shadow-lg border border-black dark:border-zinc-700">
        ...
        <ul className="space-y-3">
          {filteredTasks.map(
            (
              task // MAPPED OVER FILTERED TASKS
            ) => (
              <li
                key={task.id}
                className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-200 border border-black rounded-xl shadow-sm dark:bg-zinc-800 dark:border-zinc-700 transition-shadow hover:shadow-md">
