...
3. Use other data storage methods beside local file storage
4. On Kanban View add the ability where tasks can be dragged from "Not started" to "In Progress" for example.
5. Mobile responsiveness needs improvement as well in the future.
